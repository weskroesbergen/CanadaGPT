...
# Deploy Votes importer Cloud Run job
# This job runs hourly to check for and import new parliamentary votes

PROJECT_ID="canada-gpt-ca"
REGION="us-central1"
JOB_NAME="votes-hourly-import"
IMAGE_NAME="gcr.io/${PROJECT_ID}/${JOB_NAME}"

echo "================================================================================"
echo "DEPLOYING VOTES HOURLY IMPORT JOB"
echo "================================================================================"
...
# Create or update Cloud Scheduler job to run hourly at :15 past the hour
SCHEDULER_JOB_NAME="votes-hourly-import-trigger"
...
echo "✓ Cloud Scheduler configured to run hourly at :15 past the hour Eastern Time"
...
echo "Schedule: Hourly at :15 past the hour Eastern Time"
echo ""
