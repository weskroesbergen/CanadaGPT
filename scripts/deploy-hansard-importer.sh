...
# Deploy Hansard importer Cloud Run job
# This job runs daily at 8am to check for and import new Hansard debates

PROJECT_ID="canada-gpt-ca"
REGION="us-central1"
JOB_NAME="hansard-daily-import"
IMAGE_NAME="gcr.io/${PROJECT_ID}/${JOB_NAME}"

echo "================================================================================"
echo "DEPLOYING HANSARD DAILY IMPORT JOB"
echo "================================================================================"
...
# Create or update Cloud Scheduler job to run daily at 8am Eastern Time
SCHEDULER_JOB_NAME="hansard-daily-import-trigger"
...
echo "✓ Cloud Scheduler configured to run daily at 4:00 AM Eastern Time"
...
echo "Schedule: Daily at 4:00 AM Eastern Time"
echo ""
